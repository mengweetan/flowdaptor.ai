...
Static HTML, no build step, no JS framework. Shared design system in `assets/site.css`. Font: Menlo / monospace fallback stack. All internal links are relative — site works via `file://` or any static host.
...
- Replace Formspree placeholder with production endpoint
